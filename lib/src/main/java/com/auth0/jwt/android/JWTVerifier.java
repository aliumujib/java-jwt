package com.auth0.jwt.android;

import com.auth0.jwt.android.algorithms.Algorithm;
import com.auth0.jwt.android.exceptions.*;
import com.auth0.jwt.android.impl.JWTParser;
import com.auth0.jwt.android.interfaces.Claim;
import com.auth0.jwt.android.interfaces.DecodedJWT;
import com.auth0.jwt.android.impl.ExpectedCheckHolder;
import com.auth0.jwt.android.interfaces.Verification;
 ...
 *
 * @see com.auth0.jwt.android.interfaces.JWTVerifier
 */
public final class JWTVerifier implements com.auth0.jwt.android.interfaces.JWTVerifier {
     ...
     * builds a {@link com.auth0.jwt.android.interfaces.JWTVerifier} used to verify a JWT's signature and expected claims.
     *
     * Note that this class is <strong>not</strong> thread-safe. Calling {@link #build()} returns an instance of
     * {@link com.auth0.jwt.android.interfaces.JWTVerifier} which can be reused.
     */
