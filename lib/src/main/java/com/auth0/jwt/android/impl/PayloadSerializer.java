...
import com.auth0.jwt.android.RegisteredClaims;
import com.auth0.jwt.android.JWTCreator;
...
public class PayloadSerializer extends ClaimsSerializer<PayloadClaimsHolder> {
     ...
     * added with the {@linkplain JWTCreator.Builder#withPayload(Map)} method.
     */
