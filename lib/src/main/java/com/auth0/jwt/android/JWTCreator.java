...
import com.auth0.jwt.android.exceptions.JWTCreationException;
import com.auth0.jwt.android.exceptions.SignatureGenerationException;
import com.auth0.jwt.android.impl.*;
...
public final class JWTCreator {
    ...
    private String sign() throws SignatureGenerationException {
        String header = Base64
                .encodeToString(headerJson.getBytes(StandardCharsets.US_ASCII), Base64.URL_SAFE | Base64.NO_PADDING);
        String payload = Base64
                .encodeToString(payloadJson.getBytes(StandardCharsets.US_ASCII), Base64.URL_SAFE | Base64.NO_PADDING);

        byte[] signatureBytes = algorithm.sign(header.getBytes(StandardCharsets.US_ASCII),
